...
from others.utils import rouge_results_to_str, test_bleu, test_length, test_dist
...
class Translator(object):
    ...
    def __init__(self,
        ...
        self.tgt_seg_token = self.vocab['[unused3]']
    ...
    def translate_batch(self, batch):
        ...
        """
        _, output_data, _ = self.model(batch)
        tgt_txt = batch.tgt_txt
        return output_data, tgt_txt
