...
class GlobalAttention(nn.Module):
    ...
    * Bahdanau Attention (mlp):
    ...
    def forward(self, source, memory_bank, memory_lengths=None, memory_masks=None, coverage=None):
        """
        ...
        if memory_lengths is not None:
            ...
            align.masked_fill_(~memory_masks, -float('inf'))
